...
export class CSSProcessor {
  ...
  private async fallbackExtractClasses(css: string, classMappingCache: Map<string, string>): Promise<void> {
    // Всегда используем RegExp для извлечения классов
    await this.regexExtractClasses(css, classMappingCache);
  }

  private async regexExtractClasses(css: string, classMappingCache: Map<string, string>): Promise<void> {
